...
VJS.Volume.View.prototype.IJKBBoxOriented = function(material){
  ...
  // .5 offset is strange...
  cube.applyMatrix( new THREE.Matrix4().makeTranslation(this._volumeCore._IJK.dimensions.x/2 - .5 , this._volumeCore._IJK.dimensions.y/2 - .5, this._volumeCore._IJK.dimensions.z/2 - .5) );
  // move to RAS space
