    ...
    updateDOM() {
      ...
      if (this._cobbAngle) { // update angle label
        if (this._angle || !this._handles[3].tracking
          ...
          const rawAngle = this._handles[1].worldPosition.clone().sub(this._handles[0].worldPosition)
            .angleTo(this._handles[3].worldPosition.clone().sub(this._handles[2].worldPosition));
